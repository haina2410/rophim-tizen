                ...
                new tizen.ApplicationControl(
                    ...
                    [
                        new tizen.ApplicationControlData("module", [JSON.stringify(
                            {
                                moduleName: '@haina2410/rophim-tizen',
                                moduleType: 'npm',
                                args: launchData
                            }
                        )])
...
const dialServer = new dial.Server({
    ...
    prefix: "/dial",
    manufacturer: 'Hainam',
    modelName: 'RoPhim-Tizen',
    friendlyName: 'RoPhim-Tizen',
    delegate: {
        getApp(appName) {
            return apps[appName];
        },
...
setInterval(() => {
    tizen.application.getAppsContext((appsContext) => {
        ...
        if (!app) {
            apps["RoPhim-Tizen"].state = "stopped";
            apps["RoPhim-Tizen"].pid = null;
            apps["RoPhim-Tizen"].additionalData = {};
        }
    });
}, 5000);
