...
<h1>RoPhim-Tizen Theme Configuration</h1>
...
`;
  ...
  setTimeout(() => {
    showToast('Welcome to RoPhim-Tizen', 'Press [GREEN] to open RoPhim-Tizen Settings, press [BLUE] to open Video Speed Settings and press [RED] to open RoPhim-Tizen Theme Settings.');
  }, 2000);
