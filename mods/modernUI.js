...
export default function modernUI(update, parameters) {
    ...
    showModal('RoPhim-Tizen Settings', buttons, parameters && parameters.length > 0 ? parameters[0] : 0, 'tt-settings', update);
}
...
export function optionShow(parameters, update) {
    ...
    showModal('RoPhim-Tizen Settings', buttons, parameters.selectedIndex, 'tt-settings-options', update);
}